...
const TextStyle(color: AppColor.textBlack, );
...
TextTheme customTextTheme=TextTheme(
  ...
  headline1: _commonTextStyle.copyWith(fontWeight: FontWeight.w400,fontFamily: fontPoppins),
  headline2: _commonTextStyle.copyWith( fontWeight: FontWeight.w400,fontFamily: fontPoppins),
  headline3: _commonTextStyle.copyWith( fontWeight: FontWeight.w400,fontFamily: fontPoppins),
  headline4: _commonTextStyle.copyWith( fontWeight: FontWeight.w400,fontFamily: fontPoppins),
